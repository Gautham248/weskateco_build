...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Weskateco / Toucan Distribution Pvt Ltd describing how we collect, use, and disclose your personal information.",
};
...
<h2>Cookies</h2>
<p>Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <a href="https://www.shopify.com/legal/cookies" target="_blank" rel="noopener noreferrer">https://www.shopify.com/legal/cookies</a>. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.</p>
...
<div className="overflow-x-auto my-6">
  <table className="min-w-full text-left border-collapse border border-neutral-700">
    <thead>
      <tr className="bg-neutral-800 text-white">
        <th className="p-3 border border-neutral-700">Category</th>
        <th className="p-3 border border-neutral-700">Categories of Recipients</th>
      </tr>
    </thead>
    <tbody>
      <tr>
...
<div className="overflow-x-auto my-6">
  <table className="min-w-full text-left border-collapse border border-neutral-700">
    <thead>
      <tr className="bg-neutral-800 text-white">
        <th className="p-3 border border-neutral-700">Category of Personal Information</th>
        <th className="p-3 border border-neutral-700">Categories of Recipients</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td className="p-3 border border-neutral-700">Identifiers such as name, e-mail address and phone number</td>
        <td className="p-3 border border-neutral-700">Business and marketing partners</td>
      </tr>
      <tr>
        <td className="p-3 border border-neutral-700">Commercial information such as records of products or services purchased</td>
        <td className="p-3 border border-neutral-700">Business and marketing partners</td>
      </tr>
      <tr>
        <td className="p-3 border border-neutral-700">Usage Data</td>
        <td className="p-3 border border-neutral-700">Business and marketing partners</td>
      </tr>
    </tbody>
  </table>
  ...
  return (
    <>
      <div className="mx-auto max-w-[1200px] px-4 py-12 md:py-16">
        ...
        <Prose className="mb-8" html={privacyPolicyHtml} />
      </div>
      <Footer />
    </>
  );
