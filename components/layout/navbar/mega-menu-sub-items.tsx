        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Foreground Content */}
              <span className={`relative z-10 pl-4 transition-colors duration-150 ${isHovered ? "text-white dark:text-black" : "text-black dark:text-white"}`}>
                {item}
              </span>

              <div className={`relative z-10 pr-4 transition-colors duration-150 ${isHovered ? "text-white dark:text-black" : "text-black dark:text-white"}`}>
                <SkateboardIcon />
              </div>
            </a>
          );
