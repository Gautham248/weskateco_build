...
export default async function Footer() {
  ...
  return (
    <footer className="bg-black text-white w-full font-sans antialiased selection:bg-white selection:text-black">
      <div className="mx-auto max-w-7xl px-4 pt-30 pb-10 md:px-12 xl:px-0">

        {/* TOP SECTION: Link Columns */}
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3 lg:gap-24 mb-16">
          ...
          <div className="flex flex-col space-y-4 font-bold text-[clamp(0.75rem,2vw,1rem)] tracking-wider text-white" style={{ fontFamily: 'ClashDisplay, sans-serif' }}>
            ...
            <Link href="/blogs" className="hover:text-neutral-300 transition-colors">BLOGS</Link>
            <Link href="/stores" className="hover:text-neutral-300 transition-colors">STORES</Link>
          </div>
