      ...
      <div className="mx-auto max-w-(--breakpoint-2xl) px-4 lg:px-15 h-auto md:h-full flex flex-col">
        ...
        <div className="mt-4 md:mt-10 h-auto aspect-[10/16] max-h-[560px] md:h-full md:aspect-auto md:flex-1 md:max-h-none">
          <div
            ...
            style={{
              background:
                "linear-gradient(127.97deg, #3C3C3C 6.87%, #999999 71.92%)",
            }}
          >
            <div
            ...
            >
              ...
              <svg
                ...
                className="md:hidden w-[fit-content] h-[80%] absolute bottom-0 right-[-32px] pointer-events-none"
              >
                <path
                  d="M1 529.465V334.685C1 150.396 150.396 1.00001 334.684 1.00001"
                  stroke="url(#paint0_linear_3294_13647)"
                  strokeWidth="2"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_3294_13647"
                    x1="64.0088"
                    y1="124.017"
                    x2="334.684"
                    y2="265.233"
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="hidden md:block w-[fit-content] h-[80%] absolute top-0 right-0 pointer-events-none"
              >
                <path
                  d="M1 -0.267578C1 394.54 321.055 714.596 715.863 714.596H1081.29"
                  stroke="url(#paint0_linear_3254_912)"
                  strokeWidth="2"
                />
                <defs>
                  <linearGradient
