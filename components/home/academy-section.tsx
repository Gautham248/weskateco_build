...
export default function AcademySection() {
  return (
    <section className="h-auto aspect-square md:h-screen w-full bg-white py-4">
      <div className="relative w-full h-full">
        ...
        {/* Content Overlay */}
        <div className="relative z-10 mx-auto max-w-(--breakpoint-2xl) px-4 lg:px-15 h-auto md:h-full flex flex-col justify-between py-8 md:py-12">
          ...
          >
            <svg
              ...
              className="md:w-[40vw] w-[50vw] h-auto text-cyan-400 -skew-x-12 drop-shadow-md"
            >
              <path
          ...
          <div>
            <Link
              href="/academy"
              className="group flex items-center gap-2 rounded-full bg-black px-4 py-2 md:px-6 md:py-3 text-white text-[clamp(0.625rem,2vw,0.875rem)] font-semibold uppercase hover:opacity-90 transition-opacity w-fit"
            >
              KNOW MORE
              <svg
                width="16"
